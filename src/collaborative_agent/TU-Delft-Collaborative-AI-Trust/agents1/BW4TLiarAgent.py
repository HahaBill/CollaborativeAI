...
class LiarAgent(BaseLineAgent):
        ...
        self._possible_message_functions = \
            {
                ...
                7: self.lie_message_stored_nearby,
                8: self.lie_message_put_currently_desired
            }
    ...
    def lie_message_put_currently_desired(self, sender):
        random_index = random.randint(
            0, len(self._goalBlockCharacteristics) - 1)
        mssg = 'Put currently desired object ' + str(random_index)
        self._sendMessage(mssg, sender)
